...
| | |
|---|---|
| **Backend** | C# · .NET 8/10 · ASP.NET Core · gRPC · Clean Architecture · DDD · CQRS |
| **Microservicios** | Dapr (service invocation, pub/sub, state store) · Event Sourcing (EventStoreDB) · SignalR |
| **Datos** | MongoDB · Redis · SQL Server · PostgreSQL |
| **Testing** | xUnit · NSubstitute · Testcontainers · Playwright |
| **Infra / DevOps** | Docker · Kubernetes · Helm · Kustomize · ArgoCD · Jenkins |
